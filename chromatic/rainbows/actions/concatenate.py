...
def concatenate_in_time(self, other, maximum_fractional_difference=0.01):
    ...
    for k in self.wavelike:
        try:
            ...
            cheerfully_suggest(
                f"""
                wavelike['{k}'] does not exist in one of the Rainbows being concatenated.
                Skipping this wavelike key for the comparison.
                """
            )
    ...
    for k in self.timelike:
        try:
            ...
            cheerfully_suggest(
                f"""
                timelike['{k}'] does not exist in one of the Rainbows being concatenated.
                Skipping this timelike key in the concatenation.
                """
            )
    ...
    for k in self.fluxlike:
        try:
            ...
            cheerfully_suggest(
                f"""
                fluxlike['{k}'] does not exist in one of the Rainbows being concatenated.
                Skipping this fluxlike key in the concatenation.
                """
            )
    ...
    for k in self.timelike:
        try:
            ...
            cheerfully_suggest(
                f"""
                timelike['{k}'] does not exist in one of the Rainbows being concatenated.
                Skipping this timelike key for the comparison.
                """
            )
    ...
    for k in self.wavelike:
        try:
            ...
            cheerfully_suggest(
                f"""
                wavelike['{k}'] does not exist in one of the Rainbows being concatenated.
                Skipping this wavelike key in the concatenation.
                """
            )
